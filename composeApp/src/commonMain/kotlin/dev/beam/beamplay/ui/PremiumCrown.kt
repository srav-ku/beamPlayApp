...
/**
 * The premium mark: a small crown, matching the web app's premium glyph.
 *
 * Stroked rather than filled, and drawn with the current tint, so it sits next to the
 * "Stream" label and inherits whatever colour the button uses.
 */
val PremiumCrown: ImageVector by lazy {
    fun p(d: String) = addPathNodes(d)
    ImageVector.Builder(
        name = "PremiumCrown",
        defaultWidth = 17.dp,
        defaultHeight = 17.dp,
        ...
        // centre dot
        addPath(
            pathData = p("M12.125 12.75H12M12.25 12.75C12.25 12.8881 12.1381 13 12 13C11.8619 13 11.75 12.8881 11.75 12.75C11.75 12.6119 11.8619 12.5 12 12.5C12.1381 12.5 12.25 12.6119 12.25 12.75Z"),
            stroke = SolidColor(Color.Black),
            strokeLineWidth = 2f,
            strokeLineCap = StrokeCap.Round,
            strokeLineJoin = StrokeJoin.Round,
